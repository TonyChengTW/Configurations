...
public_endpoint=http://192.168.1.10:%(public_port)s/
...
#admin_endpoint = <None>
admin_endpoint=http://192.168.1.10:%(admin_port)s/
...
#connection = <None>
connection=mysql://root:Abc12345@192.168.1.10/keystone
...
#tcp_keepalive = falsedmin_bind_hos
...
## driver=keystone.token.providers.uuid.Provider
